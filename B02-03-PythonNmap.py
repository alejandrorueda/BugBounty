...
'''
Notas:
La librería se encuentra en la siguiente ruta: http://xael.org/norman/python/python-nmap/
La versión que se encuentra en PyPI es la 0.3.4, con lo cual, para utilizar Python-nmap sobre Python 2.x, es necesario instalar manualmente la versión 0.1.4 y no utilizar pip.
'''
import nmap
